<div>
    {{-- Page Title --}}
    @section('title', __('titles.admin.roles_and_permissions.edit_role'))
    ...
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[
            ...
            [
                'icon' => '',
                'url' => route('admin.roles-and-permissions.edit-role.render', $role->uuid),
    ...
    <x-containers.main>
                    ...
                    @forelse ($allPermissions as $permission)
                        ...
                        >
                            <input
                                ...
                                class="h-5 w-5 rounded bg-gray-100 text-blue-600 focus:ring-blue-500"
                            >
        ...
        <div class="flex justify-end items-center gap-4 mt-4">
            ...
            <x-buttons.primary-button wire:click="updateRole" size="sm">
                {{ __('admin.buttons.update_role') }}
