        ...
        <x-containers.main padding="4" class="w-1/5 overflow-y-auto">
            ...
            <div class="flex flex-col gap-y-2 mt-4">
                @foreach ($backlogs as $backlog)
                    <div class="w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-900 dark:hover:bg-gray-800 rounded-md p-2 cursor-pointer" wire:click="openBacklog('{{ $backlog->uuid }}')">
        ...
        <div class="w-4/5 overflow-y-auto">
            @if ($selectedBacklog->cards->count() > 0)
                @foreach ($selectedBacklog->cards as $card)
                    <div class="flex justify-between bg-white dark:bg-gray-800 rounded-lg px-4 py-2 mb-4 shadow-md">
                        {{-- ID & Title --}}
