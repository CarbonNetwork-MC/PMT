            ...
            <div class="mt-4 p-4">
                <div class="grid grid-cols-3">
                    <div class="col-span-1">
                        ...
                        @else
                            <p class="text-lg font-bold dark:text-white">{{ __('settings.project_name') }}</p>
                            <p class="text-sm dark:text-white mt-2">{{ $name }}</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3">
                    <div class="col-span-2">
                        ...
                        @else
                            <p class="text-lg font-bold dark:text-white">{{ __('settings.project_description') }}</p>
                            <p class="text-sm dark:text-white mt-2">{{ $description }}</p>
                        @endif
                    </div>
                </div>
            </div>
