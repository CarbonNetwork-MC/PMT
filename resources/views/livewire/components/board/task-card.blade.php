...
>
    ...
    >
        ...
        >
            <x-forms.text-area
                class="block w-full"
                placeholder="{{ __('board.placeholders.task_description') }}"
                rows="3"
    ...
    <div class="flex items-center justify-end">
        <div class="flex items-center gap-1">
            ...
            <div class="flex justify-end">
                <div @if ($task->card->sprint->status === 'active') x-data="{ open: false }" @endif class="relative flex items-center gap-x-2 bg-gray-200 dark:bg-gray-900 rounded-md px-2.5">
                    <i 
                        @if ($task->card->sprint->status === 'active') @click="open = !open" @endif
                        class="fi fi-sr-users text-xs text-gray-700 dark:text-white {{ ($task->card->sprint->status === 'active') ? 'cursor-pointer' : '' }}"
                    ></i>
