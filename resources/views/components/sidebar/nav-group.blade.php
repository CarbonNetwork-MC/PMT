...
<div>
    <button
        ...
        class="w-full items-center gap-3 rounded-xl px-2 text-sm font-medium text-white hover:bg-zinc-800 cursor-pointer"
        :class="!isCollapsed ? 'flex py-2' : ''">

        <span 
            class="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-zinc-900 dark:bg-zinc-800"
