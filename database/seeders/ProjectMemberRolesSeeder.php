...
class ProjectMemberRolesSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $roles = [
            ...
            ['name' => 'Project Manager', 'short_name' => 'pm', 'permissions' => json_encode(['create_project' => true, 'delete_project' => true, 'update_project' => true, 'delete_card' => true, 'delete_task' => true])]
        ];
